<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseBooking" class="collapse" aria-labelledby="headingBooking" data-parent="#accordionSidebar">
            <div class="bg-primary py-2 collapse-inner rounded">
                <a class="collapse-item" href="./booking.php">View Booking</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseServices" class="collapse" aria-labelledby="headingServices" data-parent="#accordionSidebar">
            <div class="bg-primary py-2 collapse-inner rounded">
                <a class="collapse-item" href="./service-create.php">Add Services</a>
                <a class="collapse-item" href="./service.php">View Services</a>
            </div>
        </div>
    </li>

    <!-- Manage Inquiries Links -->
    <li class="nav-item">
        ...
        <div id="collapseInquiries" class="collapse" aria-labelledby="headingInquiries" data-parent="#accordionSidebar">
            <div class="bg-primary py-2 collapse-inner rounded">
                <a class="collapse-item" href="./message.php">View Inquiries</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseCategories" class="collapse" aria-labelledby="headingCategories" data-parent="#accordionSidebar">
            <div class="bg-primary py-2 collapse-inner rounded">
                <a class="collapse-item" href="categories-create.php">Add Category</a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseProducts" class="collapse" aria-labelledby="headingProducts" data-parent="#accordionSidebar">
            <div class="bg-primary py-2 collapse-inner rounded">
                <a class="collapse-item" href="product-create.php">Add Product</a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseAdmins" class="collapse" aria-labelledby="headingAdmins" data-parent="#accordionSidebar">
            <div class="bg-primary py-2 collapse-inner rounded">
                <a class="collapse-item" href="admins-create.php">Add Admin</a>
                <a class="collapse-item" href="admins.php">View Admin</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseCustomers" class="collapse" aria-labelledby="headingCustomers" data-parent="#accordionSidebar">
            <div class="bg-primary py-2 collapse-inner rounded">
                <a class="collapse-item" href="customer.php">View Customer</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseHomepage" class="collapse" aria-labelledby="headingHomepage" data-parent="#accordionSidebar">
            <div class="bg-primary py-2 collapse-inner rounded">
                <a class="collapse-item" href="homepage-create.php">Add Images</a>
                <a class="collapse-item" href="homepage.php">View Images</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseAboutus" class="collapse" aria-labelledby="headingAboutus" data-parent="#accordionSidebar">
            <div class="bg-primary py-2 collapse-inner rounded">
                <a class="collapse-item" href="aboutus-create.php">Add About Us</a>
                <a class="collapse-item" href="aboutus.php">View About Us</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseAddress" class="collapse" aria-labelledby="headingAddress" data-parent="#accordionSidebar">
            <div class="bg-primary py-2 collapse-inner rounded">
                <a class="collapse-item" href="location-add.php">Add Address</a>
                <a class="collapse-item" href="location.php">View Address</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseSocial" class="collapse" aria-labelledby="headingSocial" data-parent="#accordionSidebar">
            <div class="bg-primary py-2 collapse-inner rounded">
                <a class="collapse-item" href="social-create.php">Add Social</a>
                <a class="collapse-item" href="social.php">View Social</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTerms" class="collapse" aria-labelledby="headingTerms" data-parent="#accordionSidebar">
            <div class="bg-primary py-2 collapse-inner rounded">
                <a class="collapse-item" href="terms-create.php">Add Terms</a>
                <a class="collapse-item" href="terms.php">View Terms</a>
            </div>
        </div>
    </li>
