    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="card mt-4 shadow" style="min-width: 800px;">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="mb-0">Add New Image to Homepage</h4>
                <a href="homepage.php" class="btn btn-danger">Back to Homepage</a>
            </div>
            <div class="card-body">
                ...
                <?php alertMessage(); ?>
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <br>
                            <button type="submit" name="saveImage" class="btn btn-primary">Save</button>
                        </div>
                    </div>
                </form>
            </div>
