    ...
    <div class="container overflow-hidden">
      <div class="row gy-4 gy-lg-0 justify-content-xl-between">
        <div class="col-12 col-md-4 col-lg-3 col-xl-2">
          <div class="widget">
            <a href="#!">
              <img src="admin/admin1/assets/img/bluebajaj.png" alt=" Bajaj Logo" width="75" height="57">
            </a><br>
           <span><b style ="color:blue;">BAJAJ BHAKTAPUR</b></span> 
           <p>Bajaj Bhaktapur is a premier dealership in Bhaktapur, Nepal, offering a wide range of Bajaj motorcycles and exceptional customer service.</p>
          </div>
        </div>
        <div class="col-12 col-md-4 col-lg-3 col-xl-2">
          <div class="widget">
            <h4 class="widget-title mb-4">Get in Touch</h4>
            <address class="mb-4"><?php 
            $location = getAll('locations');
            if(mysqli_num_rows($location) > 0):
                foreach($location as $item): 
            ?>  
        <p><?= htmlspecialchars($item['address']) ?>
        </p>
        <?php 
                endforeach;
            else:
            ...
            <?php endif; ?></address>
            <p class="mb-1">
              <a class="link-secondary text-decoration-none" href="tel:+15057922430">  
        ...
        <?php 
            ...
            <p class="mb-0">
              <a class="link-secondary text-decoration-none" href="">
                <?php $location = getAll('locations');
            if(mysqli_num_rows($location) > 0):
                foreach($location as $item): 
            ?>
        <p><?= htmlspecialchars($item['email']) ?>
        </p>
        <?php 
                endforeach;
            else:
            ...
            if(mysqli_num_rows($location) > 0):
                foreach($location as $item): 
            ?>
        <p><?= htmlspecialchars($item['website']) ?>
        </p>
        <?php 
                endforeach;
            else:
            ...
            if(mysqli_num_rows($location) > 0):
                foreach($location as $item): 
            ?>
        <p> OpenTime: <?= htmlspecialchars($item['opentime']) ?>
        </p>
        <?php 
                endforeach;
            else:
            ...
            if(mysqli_num_rows($location) > 0):
                foreach($location as $item): 
            ?>
        <p> Close Time: <?= htmlspecialchars($item['closetime']) ?>
        </p>
        <?php 
                endforeach;
            else:
        ...
        <div class="col-12 col-md-4 col-lg-3 col-xl-2">
          <div class="widget">
            ...
            <ul class="list-unstyled">
              <li class="mb-2">
                <a href="./aboutus.php" class="link-secondary text-decoration-none">About us</a>
              </li>
              <li class="mb-2">
                <a href="./contactus.php" class="link-secondary text-decoration-none">Contact</a>
              </li>
                    ...
                    ?>
                            <ul class="list-unstyled m-0 p-0 d-flex justify-content-center justify-content-md-end">
                                <?php if (!empty($item['facebook'])) : ?>
                                    <li class="me-3">
                                        <a href="<?= htmlspecialchars($item['facebook']) ?>" class="link-dark link-opacity-75-hover">
...
<path fill="#3f51b5" d="M24 4A20 20 0 1 0 24 44A20 20 0 1 0 24 4Z"></path><path fill="#fff" d="M29.368,24H26v12h-5V24h-3v-4h3v-2.41c0.002-3.508,1.459-5.59,5.592-5.59H30v4h-2.287 C26.104,16,26,16.6,26,17.723V20h4L29.368,24z"></path>
                                ...
                                <?php if (!empty($item['youtube'])) : ?>
                                    <li class="me-3">
                                        <a href="<?= htmlspecialchars($item['youtube']) ?>" class="link-dark link-opacity-75-hover">
                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28" height="28" viewBox="0 0 48 48">
<path fill="#FF3D00" d="M43.2,33.9c-0.4,2.1-2.1,3.7-4.2,4c-3.3,0.5-8.8,1.1-15,1.1c-6.1,0-11.6-0.6-15-1.1c-2.1-0.3-3.8-1.9-4.2-4C4.4,31.6,4,28.2,4,24c0-4.2,0.4-7.6,0.8-9.9c0.4-2.1,2.1-3.7,4.2-4C12.3,9.6,17.8,9,24,9c6.2,0,11.6,0.6,15,1.1c2.1,0.3,3.8,1.9,4.2,4c0.4,2.3,0.9,5.7,0.9,9.9C44,28.2,43.6,31.6,43.2,33.9z"></path><path fill="#FFF" d="M20 31L20 17 32 24z"></path>
                                ...
                                <?php if (!empty($item['twitter'])) : ?>
                                    <li class="me-3">
                                        <a href="<?= htmlspecialchars($item['twitter']) ?>" class
="link-dark link-opacity-75-hover">
<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28" height="28" viewBox="0 0 48 48">
...
<?php if (!empty($item['instagram'])) : ?>
                                <li>
                                    <a href="<?= htmlspecialchars($item['instagram']) ?>" class="link-dark link-opacity-75-hover">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28" height="28" viewBox="0 0 48 48">
